...
func TestRemotePeeringLeftoverNamespaces(t *testing.T) {
	t.Parallel()
	if got := remotePeeringLeftoverNamespaces(""); len(got) != 0 {
		t.Fatalf("empty id: %v", got)
	}
	got := remotePeeringLeftoverNamespaces("0c7619b5-9d00-44a9-aa60-00034df02ddd")
	want := []string{
		"0c7619b5-9d00-44a9-aa60-00034df02ddd-operator",
		"0c7619b5-9d00-44a9-aa60-00034df02ddd-vnc-gateway",
		"liqo-tenant-0c7619b5-9d00-44a9-aa60-00034df02ddd",
	}
	if len(got) != len(want) {
